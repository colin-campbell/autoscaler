...
func TestLoad(t *testing.T) {
	environ := map[string]string{
		...
		"DRONE_OPENSTACK_AVAILABILITY_ZONE": "zone1",
		"DRONE_OPENSTACK_IP_POOL":           "ext-ips-1",
		"DRONE_OPENSTACK_NETWORK_TYPE":      "neutron",
		"DRONE_OPENSTACK_NETWORK_ID":        "831a1f9d-dd17-4d3d-ad22-c9621e0a22a0",
...
var jsonConfig = []byte(`{
  ...
  "OpenStack": {
	...
	"NetworkType": "neutron",
	"NetworkId": "831a1f9d-dd17-4d3d-ad22-c9621e0a22a0",
